  ...
  return (
    <div className='bg-slate-800 col-span-2 '>
      ...
      <div className='flex justify-between p-2 items-center
       bg-slate-700 '>
        <img className='rounded-full h-9 w-9' src='https://pps.whatsapp.net/v/t61.24694-24/298328542_766611371246745_4042993338047187675_n.jpg?stp=dst-jpg_s96x96&ccb=11-4&oh=01_AdQ6a3x2ARD1hT4VnsgE_07mPcY-3a3odBTy5qiA4flA5Q&oe=639876BD' />
